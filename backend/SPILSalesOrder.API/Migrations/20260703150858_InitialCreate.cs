    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "No 10", "Main Street", "Colombo", "ABC Traders", "00300", "Western", "Colombo 03" },
                    { 2, "No 22", "Lake Road", "Kandy", "Green Mart", "20000", "Central", "Kandy" },
                    { 3, "No 45", "Galle Road", "Gampaha", "Tech World", "11000", "Western", "Gampaha" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Laptop", "ITM001", 250000m },
                    { 2, "Mouse", "ITM002", 2500m },
                    { 3, "Keyboard", "ITM003", 6500m },
                    { 4, "Monitor", "ITM004", 45000m },
                    { 5, "Printer", "ITM005", 75000m }
                });
